...
flags.DEFINE_string("game_name", "dark_hex", "the id of the OpenSpiel game")
...
flags.DEFINE_float("ent_coef", 0.05, "coefficient of the entropy")
...
def main(_):
  ...
  path = f"/admin/home-willb/ent-reg-marl/tmp/{FLAGS.game_name}"
  os.makedirs(path, exist_ok=True)
  agent.save(f"{path}/actor.pth")
