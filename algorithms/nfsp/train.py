...
flags.DEFINE_integer("num_train_environment_steps", int(10e6),
                     "Number of training episodes.")
...
flags.DEFINE_string("checkpoint_dir", f"/admin/home-willb/gtrl/tmp/nfsp_{game}",
...
def main(unused_argv):
    ...
    print(f"Training NFSP on: {jax.devices()}")
    for ep in range(FLAGS.num_train_episodes):
        ...
        if agents[0].get_step_counter() >= FLAGS.num_train_environment_steps:
            print("Training complete.", agents[0].step_counter)
            break
